...
<section class="mb-12 w-full bg-black text-white py-10">
    <div class="flex flex-col gap-5 md:flex-row md:justify-around">
        ...
        <div class="w-full rounded-3xl  p-5 md:flex md:flex-col md:items-center">
            <h2 class="mb-4 text-white text-center md:text-left">{!! __('secure.confidential') !!}</h2>
            <ul class="space-y-3">
                <li class="flex gap-3">
                    <svg class="w-5 h-5 shrink-0 text-primary-light" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 640">
                ...
                <li class="flex gap-3">
                    ...
                    <span>{{ __('secure.committed') }}</span>
                </li>
            </ul>
        </div>

        <div class="w-full rounded-3xl bg-black p-5 md:flex md:flex-col md:items-center">
            <h2 class="mb-4 text-primary-light text-center md:text-left">{{ __('secure.why') }}</h2>
            <ul class="space-y-3 text-sm">
                <li class="flex gap-3">
                    ...
                    <p>{!! __('secure.whyFirstParagraph') !!}</p>
                </li>
                <li class="flex gap-3">
                    <svg class="w-5 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        <path fill="#cd7f4a"
                    ...
                    <p>{!! __('secure.whySecondParagraph') !!}</p>
                </li>
            </ul>
        </div>
