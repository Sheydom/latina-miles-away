<footer class="flex flex-col text-center bg-soft font-sanse">


    <div>
        <h3 class="text-black mb-6">Ready for your Australian chapter?</h3>
        <p class="mb-6">Take the first step with a confidentional migration assessment today</p>
        <button type="button"
            class=" mb-10  rounded-2xl p-4 font-bold text-2xl text-amber-50 bg-gradient-to-r from-[#34A0A9] to-[#4CC9D4] shadow-2xl cursor-pointer">Book
            Assessment</button>
        <div class="flex flex-col text-left bg-white">
            <div class="flex gap-4 justify-center">
                ...
                </svg><svg xmlns="http://www.w3.org/2000/svg" height="32" width="28"
                    viewBox="0 0 448 512"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
                    <path
            ...
            <p class="text-center">© 2026 Latina Miles Away
