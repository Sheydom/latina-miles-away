<section id="services" class="hidden sm:block w-full mt-20  overflow-hidden">
    ...
    <div class="flex gap-10 w-full justify-center">
        <p class="text-sm flex text-neutral-500 mb-2 ">
            {!! __('service.swipe') !!}
        </p>
    </div>
</section>
<section id="" class=" sm:hidden w-full mb-10 items-center ">
    <div class="flex flex-col items-center p-2">
