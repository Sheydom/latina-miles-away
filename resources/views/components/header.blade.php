<nav class="flex bg-soft px-2.5 sticky top-0 z-50">
    <div class="flex w-full justify-between">
        <div class="flex gap-5  items-center">
          ...
          hover:scale-[1.02]
          transition duration-200"">Enquire
                Now</button><button
                class="p-1 rounded-xl border border-primary text-primary hover:text-white hover:bg-primary transition duration-200 ease-in-out">Ressources</button>
        </div>
