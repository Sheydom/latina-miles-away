<section class="flex flex-col items-center mb-12 w-full">
    <div class="w-[100%] bg-white rounded-3xl pt-5 pb-5  flex flex-col items-center mb-5">
    ...
    <div class="bg-white rounded-3xl p-4">
        <h2 class="text-black text-center mb-4 ">Why this matters</h2>
        <ul class="flex flex-col text-sm">
            ...
            <li class="flex items-start gap-3"><svg class="w-5 h-5 shrink-0" xmlns="http://www.w3.org/2000/svg"
                ...
                <p>
                    <strong>Strategic Safety:</strong> Migration strategies are kept confidential between you and your
                    advisor.
                </p>
            </li>
        </ul>
