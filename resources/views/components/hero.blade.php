    ...
    <div>
        <div class="flex justify-end md:justify-start">
            <p class=" bg-blue-100 h-max p-1 text-xs rounded-2xl mb-5 flex items-center"><svg class="w-5 h-5 shrink-0"
                ...
                </svg>Based in Melbourne</p>
        </div>
        <h1 class="mb-5 md:text-7xl">Everything <br class="sm:hidden"> you need <br class="hidden sm:block"> to <br class="sm:hidden">start in Australia</h1>
        <p class="md:max-w-100">Real guidance from someone who has been in your shoes — helping you avoid mistakes and make smarter decisions from day one.
        </p>
