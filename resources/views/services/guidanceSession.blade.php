        ...
        <div class="w-full md:w-max  p-5 md:px-5 md:grid md:grid-cols-[400px_max(600px)] ">
            <div
                ...
                <div class="mb-5">
                    ...
                    <ul class="space-y-2 text-sm md:text-base text-neutral-700 list-disc marker:text-tertiary px-5">
                ...
                <div>
                    ...
                    <div class="md:rounded-bl-none">
                        ...
                        <div class="mb-5 md:mt-5  p-5 md:p-0 md:text-left md:w-full">
                            ...
                            <ul class="space-y-2  flex md:flex-col justify-around  text-left text-sm md:text-base text-neutral-700 ">
