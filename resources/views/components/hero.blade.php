<section
    class=" bg-linear-to-br from-[primary-light] to-primary p-5 rounded-xl mb-10 mt-10 md:w-full md:max-w-[100vw] md:items-center md:flex md:justify-around">
    <div>
        ...
        <p class="md:max-w-100">Connecting the Latin community with Australian opportunities through guidance and
            reliable support.
        </p>
